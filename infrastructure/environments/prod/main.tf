...
module "gke" {
  ...
  region                        = var.region
  name_prefix                   = "${var.name_prefix}-prod"
  cluster_name                  = "${var.name_prefix}-gke-prod"
...
module "artifact_registry" {
  ...
  region                 = var.region
  project_id             = var.project_id
  artifact_registry_name = "${var.artifact_registry_name}-prod"
}
...
module "helm" {
  ...
  image_repository  = "${var.region}-docker.pkg.dev/${var.project_id}/${var.artifact_registry_name}-prod/task-manager"
